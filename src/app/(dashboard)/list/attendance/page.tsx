...
import { Attendance, Lesson, Prisma, Student } from "@/generated/prisma/client";
          ...
          <div className="flex items-center gap-4 self-end">
            ...
            <ExportButton
              ...
              csvData={data.map((a) => ({
                ...
                Date: new Intl.DateTimeFormat("en-US").format(a.date),
                Present: a.present ? "Yes" : "No",
              }))}
              pdfTitle="Attendance Records"
              pdfHeaders={["Student", "Lesson", "Date", "Present"]}
              pdfRows={data.map((a) => [
                a.student.name + " " + a.student.surname,
                a.lesson.name,
                new Intl.DateTimeFormat("en-US").format(a.date),
                a.present ? "Yes" : "No",
              ])}
            />
            {(role === "admin" || role === "teacher") && (
